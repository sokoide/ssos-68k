...
#define SS_CONFIG_MEMORY_TOTAL_SIZE \
    (SS_CONFIG_MEMORY_BLOCK_SIZE * SS_CONFIG_MEMORY_BLOCKS)
...
// Performance monitoring constants - can be runtime configurable (no struct
// impact)

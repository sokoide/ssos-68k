...
void ss_dwaw(uint16_t color, int x0, int y0, int x1, int y1);
void ss_draw_rect_v(volatile uint16_t* vram, uint16_t sw, uint16_t sh, uint16_t color, int x0, int y0, int x1, int y1);

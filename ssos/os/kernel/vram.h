...
void ss_fill_rect_v(uint16_t* vram, uint16_t sw, uint16_t sh, uint16_t color, int x0, int y0, int x1, int y1);

void ss_draw_rect(uint16_t color, int x0, int y0, int x1, int y1);
void ss_draw_rect_v(uint16_t* vram, uint16_t sw, uint16_t sh, uint16_t color, int x0, int y0, int x1, int y1);

void ss_put_char(uint16_t fg_color, uint16_t bg_color, int x, int y, char c);
void ss_put_char_v(uint16_t* vram, uint16_t sw, uint16_t sh, uint16_t fg_color, uint16_t bg_color, int x, int y, char c);

void ss_print(uint16_t fg_color, uint16_t bg_color, int x, int y, char* str);
void ss_print_v(uint16_t* vram, uint16_t sw, uint16_t sh, uint16_t fg_color, uint16_t bg_color, int x, int y, char* str);

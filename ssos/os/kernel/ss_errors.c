...
const char* ss_error_to_string(SsError error) {
    switch (error) {
        ...
        case SS_ERROR_NULL_PTR: return "NULL pointer error";
        case SS_ERROR_INVALID_PARAM: return "Invalid parameter";
        case SS_ERROR_OUT_OF_BOUNDS: return "Out of bounds";
        case SS_ERROR_INVALID_ID: return "Invalid ID";
        case SS_ERROR_OUT_OF_MEMORY: return "Out of memory";
        case SS_ERROR_OUT_OF_RESOURCES: return "Out of resources";
        case SS_ERROR_RESOURCE_BUSY: return "Resource busy";
        case SS_ERROR_INVALID_STATE: return "Invalid state";
        case SS_ERROR_NOT_INITIALIZED: return "Not initialized";
        case SS_ERROR_ALREADY_INITIALIZED: return "Already initialized";
        case SS_ERROR_SYSTEM_ERROR: return "System error";
        case SS_ERROR_HARDWARE_ERROR: return "Hardware error";
        case SS_ERROR_TIMEOUT: return "Timeout error";

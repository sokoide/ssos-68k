...
/* Repaint only a rectangular region: stipple its background and redraw
 * visible windows overlapping it, in z-order.  Used by drag drop to
 * restore the vacated old position without a full screen repaint. */
